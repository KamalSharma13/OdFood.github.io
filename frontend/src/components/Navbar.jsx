...
<motion.nav className="navbar navbar-expand-lg navbar-dark bg-danger" initial={{y:-250}} animate={{y:0}} transition={{
      delay:.1,
      duration:1,
      yoyo: Infinity,
      }}>
  <div className="container-fluid">
    <Link className="navbar-brand fs-1 fst-italic" to="/">OdFood</Link>
